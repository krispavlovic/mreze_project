...
namespace BarmenClient
{
    ...
    internal class Barmen
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Barmen povezan. Ceka dodelu zadataka...\n");
                ...
                if (tcp.Poll(200 * 1000, SelectMode.SelectRead)) // 0.2s
                {
                    ...
                    while ((idx = rxBuffer.IndexOf('\n')) >= 0)
                    {
                        ...
                        try
                        {
                            ...
                            if (tip == "stack_update_barmen")
                            {

                                if (data.stackStavki.Count == 0)
                                {
                                    Console.WriteLine("Nema novih porudzbina za bar.");
                                }
                                else
                                {
                                    ...
                                    Console.WriteLine("Lista novih porudzbina za bar:\n");
